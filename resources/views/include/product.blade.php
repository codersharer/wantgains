                        ...
                        <div class="float-right">
                            ...
                            {{--<a href="{{ route('product.out', ['productId' => $product['id']]) }}"--}}
                               {{--class="btn btn-primary product-out"><i--}}
                                ...
                                {{--deal</a>--}}
                            <a href="#" class="btn btn-primary product-promotion-modal" data-toggle="modal" data-product-id="{{ $product['id'] }}"><i class="iconfont icon-open mr-1"></i>{{ __('Get promotion') }}</a>
